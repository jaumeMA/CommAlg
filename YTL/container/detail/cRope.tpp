...
template<typename StringAllocator>
void cRopeNode<StringAllocator>::setHeight(unsigned short i_height)
{
    m_height = i_height;
}
template<typename StringAllocator>
unsigned short cRopeNode<StringAllocator>::getHeight() const
{
    return m_height;
}
template<typename StringAllocator>
...
template<template<typename> class Allocator, typename StringAllocator>
const char& cRope<Allocator,StringAllocator>::getValue(node_pointer_type currNode) const
{
...
template<template<typename> class Allocator, typename StringAllocator>
char& cRope<Allocator,StringAllocator>::getValue(node_pointer_type currNode)
{
