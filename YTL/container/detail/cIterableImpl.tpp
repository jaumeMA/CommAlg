...
{
    return reinterpret_cast<forwarded_node_pointer_type>((char*)memcpy((char*)memcpy(k_pairAllocator.allocate(1, sizeof(pair_node)),&i_interface, sizeof(i_interface)) + sizeof(i_interface),&i_pointer, sizeof(i_pointer)) - sizeof(i_interface));
}
template<typename Traits, int ... indexs>
