...
{
    size_t dataSize = getLengthStringArray(data);
...
template<typename A>
cString<A>::cString(const char *data, size_t length)
{
    this->m_size = length;
...
template<typename A>
cString<A>::cString(char value, size_t length)
{
    this->m_size = length;
...
template<typename A>
void cString<A>::resize(size_t size, size_t initPos)
{
...
template<typename A>
cString<A> cString<A>::subStr(const size_t initPos, const size_t length) const
{
    return cArray<char,A>::subArr(initPos,length);
}
template<typename A>
cString<A> cString<A>::subStr(const size_t initPos) const
{
...
cArray<cString<A>> cString<A>::tokenize(const cString<A>& separator) const
{
    ...
    for(size_t i=0;i<resLocal.getSize();i++)
    {
...
template<typename A>
cString<A> cString<A>::subArr(const size_t initPos, const size_t length) const
{
