...
class cIterablePackIterableImpl : public Traits::iterable_type
{
...
public:
    ...
    cIterablePackIterableImpl(const iterable_pack& i_iterables);
    template<typename ... IIterables>
    cIterablePackIterableImpl(IIterables&& ... i_iterables);
...
template<typename Traits>
class cInputIterablePackIterableImpl : public cIterablePackIterableImpl<Traits>
{
    typedef cIterablePackIterableImpl<Traits> base_type;
    typedef typename Traits::node_pointer_type node_pointer_type;
...
template<typename Traits>
using cForwardIterablePackIterableImpl = cInputIterablePackIterableImpl<Traits>;

template<typename Traits>
class cBidirectionalIterablePackIterableImpl : public cForwardIterablePackIterableImpl<Traits>
{
    typedef cForwardIterablePackIterableImpl<Traits> base_type;
    typedef typename Traits::private_node_pointer_type private_node_pointer_type;
	typedef typename Traits::node_pointer_type node_pointer_type;
...
template<typename Traits>
class cRandomAccessIterablePackIterableImpl : public cBidirectionalIterablePackIterableImpl<Traits>
{
    typedef cBidirectionalIterablePackIterableImpl<Traits> base_type;
    typedef typename Traits::private_node_pointer_type private_node_pointer_type;
	typedef typename Traits::node_pointer_type node_pointer_type;
...
#include "YTL/container/detail/cIterablePackIterableImpl.tpp"
