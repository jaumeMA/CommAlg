...
public:
    ...
    inline void setHeight(unsigned short i_height);
...
template<template<typename> class Allocator = memory::cTypedSystemAllocator, typename StringAllocator = memory::cTypedSystemAllocator<char>>
class cRope : public detail::cRandomAccessIterableBaseImpl<char&>
{
    typedef detail::cRopeNode<StringAllocator> RopeNode;
    typedef detail::cRopeLeave<StringAllocator> RopeLeave;
    typedef detail::cRandomAccessIterableBaseImpl<char&> iterable_type;
    static const size_t k_chunkSize = NUM_STACK_CHARS * sizeof(char);
...
public:
    ...
    typedef typename detail::cRandomAccessIterableBaseImpl<char&>::iterator_type iterator_type;
    typedef typename detail::cRandomAccessIterableBaseImpl<char&>::const_iterator_type const_iterator_type;
    typedef typename detail::cRandomAccessIterableBaseImpl<char&>::reverse_iterator_type reverse_iterator_type;
    typedef typename detail::cRandomAccessIterableBaseImpl<char&>::const_reverse_iterator_type const_reverse_iterator_type;
    typedef typename detail::cRandomAccessIterableBaseImpl<char&>::pointer_type pointer_type;
    typedef typename detail::cRandomAccessIterableBaseImpl<char&>::node_pointer_type node_pointer_type;
    typedef typename detail::cRandomAccessIterableBaseImpl<char&>::iterable_public_interface iterable_public_interface;
    typedef typename detail::cRandomAccessIterableBaseImpl<char&>::add_type add_type;
...
private:
    ...
    const char& getValue(node_pointer_type currNode) const override;
    char& getValue(node_pointer_type currNode) override;
