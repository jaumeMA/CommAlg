...
public:
    ...
    cString<A>(const char* data, size_t length);
    cString<A>(char value, size_t length=1);
    cString<A>(const std::string& str);
    cString<A>(const const_string_view& str);
    cString<A>(const string_view& str);
    ~cString<A>();
    void resize(size_t size, size_t initPos=0);
    const char *getStr() const;
    char *getStr();
    cString<A> subStr(const size_t initPos, const size_t length) const;
    cString<A> subStr(const size_t initPos) const;
    ...
    cString<A> subArr(const size_t initPos, const size_t length) const;
