...
{
    static const bool value = (nth_pos_of_predicate<is_same_type, Type, Types...>::value != std::numeric_limits<size_t>::max());
};
...
{
    static const bool value = (nth_pos_of_predicate<is_type_constructible, Type, Types...>::value != std::numeric_limits<size_t>::max());
};
...
template<typename T>
constexpr unsigned short getDepthTupleType(T)
{
    return 0;
}

template<typename T>
constexpr unsigned short getDepthTupleType(typename T::primitive_type)
{
...
{
    static const unsigned int value = num*Prod<nums...>::value;
};
...
struct Prod_Max<num,nums...>
{
    ...
    {
        static const unsigned int value = is_min< num,otherNum,(num>otherNum) >::value * Prod_Max<nums...>::template with<dummy,otherNums...>::value;
    };

    template<class dummy>
    struct with<dummy>
    {
        static const unsigned int value = num*Prod_Max<nums...>::template with<dummy>::value;
    };
};
...
struct Prod_Max<>
{
    ...
    struct with<dummy,otherNum,otherNums...>
    {
        static const unsigned int value = otherNum*Prod_Max<>::template with<dummy,otherNums...>::value;
    };
...
struct NoverM
{
    static const unsigned int value = Factorial<N>::value/Factorial<M>::value;
};
