...
namespace time
{
inline void Delay(int milisecs)
{
...
inline void Sleep(int milisecs)
{
...
inline int secToMilisec(int secs)
{
    int res = 0;
...
inline int milisecToSecs(int milisecs)
{
    int res = 0;
...
inline int secToNanosecs(int secs)
{
    int res = 0;
...
inline int milisecToNanosecs(int milis)
{
    int res = 0;
