...
private:
    ...
    public:
        cPool();
        cPool(void* address, unsigned int totalSize);
    ...
    private:
        ...
        public:
            ...
            cBuddyFreeList(unsigned short i_size);
        ...
        private:
            ...
            const unsigned short m_powerOfTwo = 0;
        };

        container::cArray<cBuddyFreeList>     m_buddyBlocks;
        void*                                m_pAddress;
        unsigned int                        m_totalSize;
        container::cTrie<unsigned short,container::cByteSet<>>         m_allocations;
    };

    cBuddyAllocator(size_t poolSize);
    void init();
    void* AllocatePool(void* initialAddress, unsigned int length) const;
