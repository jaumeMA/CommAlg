...
template<typename T, template<typename> class A>
class cPolynomialValue : public container::detail::cMultiMapValue<T,signed short,container::cAVLtree,A,container::RecursiveBalancer<container::cAVLtree>::Balancer,cPolynomialValue<T,A>>
{
public:
    typedef container::detail::cMultiMapValue<T,signed short,container::cAVLtree,A,container::RecursiveBalancer<container::cAVLtree>::Balancer,cPolynomialValue<T,A>> MapValue;
	...
	underlying_type& getAt(signed short key, Args&& ... keys);
	template<typename ... Args>
	const underlying_type& getAt(signed short key, Args&& ... keys) const;
...
template<typename T, template<typename> class A = memory::cTypedSystemAllocator>
using cPolynomial = container::detail::cMultiMapImpl<cPolynomialValue<T,A>,signed short,container::cAVLtree,A,container::MultiBalancer<container::cAVLtree>::Balancer>;
